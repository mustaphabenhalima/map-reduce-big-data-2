...
import com.opstty.default_reducer;

public class ShowAllExistingSpecies {
    // MapReduce job that displays the list of different showAllExistingSpecies trees in trees.csv
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage : showAllExistingSpecies <in> <out>");
        ...
        Job job = Job.getInstance(conf, "showAllExistingSpecies"); // Job name
        job.setJarByClass(ShowAllExistingSpecies.class);

        // Set Mapper to showAllExistingSpecies_mapper
        job.setMapperClass(mapperNumberOfTreesByKinds.class);
