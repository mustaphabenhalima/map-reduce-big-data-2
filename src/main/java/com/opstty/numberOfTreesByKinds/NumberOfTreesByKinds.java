...
public class NumberOfTreesByKinds {
    ...
    public static void main(String[] args) throws Exception{
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage: numberOfTreesByKinds <in> <out>");
        ...
        Job job = Job.getInstance(conf, "numberOfTreesByKinds"); // Job name
        job.setJarByClass(NumberOfTreesByKinds.class);
